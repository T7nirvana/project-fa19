...
def random_input(m, n, *param):
	...
	in_str = in_str + '\n' + 'Soda' + '\n'
	in_str = in_str + adjacent_matrix(m,n,ratio)
	return in_str


def save_file(m, n, *param):
	in_str = random_input(m, n, *param)
...
if __name__ == '__main__':
	...
	save_file(50, 25,ratio)
	save_file(100, 50,ratio)
	save_file(200, 100,ratio)
